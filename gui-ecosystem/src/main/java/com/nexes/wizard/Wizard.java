...
import static org.blackpanther.ecosystem.helper.Helper.getImage;
...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public Wizard(Frame owner) {
        this(owner, new WizardModel());
    }

    public Wizard(Frame owner, WizardModel model) {
        require(model != null);
        wizardModel = model;
    ...
    static {
        try {
            ...
            BACK_TEXT = resources.getString("backButtonText");
            NEXT_TEXT = resources.getString("nextButtonText");
            CANCEL_TEXT = resources.getString("cancelButtonText");
            FINISH_TEXT = resources.getString("finishButtonText");

            BACK_ICON = new ImageIcon(
                    getImage(resources.getString("backButtonIcon")));
            NEXT_ICON = new ImageIcon(
                    getImage(resources.getString("nextButtonIcon")));
            CANCEL_ICON = new ImageIcon(
                    getImage(resources.getString("cancelButtonIcon")));
            FINISH_ICON = new ImageIcon(
                    getImage(resources.getString("finishButtonIcon")));
